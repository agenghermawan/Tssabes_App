                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{route('event.store')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-10 form-group">
                                                    <input type="text" name="organizer" id="email-id" class="form-control" name="email-id"
